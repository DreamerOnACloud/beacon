...
- "Done" is a gut call: does the published post satisfy the three-part template (concept explanation, playable example, further reading) described in `idea.md`? No separate checklist to consult.
